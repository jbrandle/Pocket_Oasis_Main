...
import { ArrowLeft, User, Target, Save, LogOut, Zap, Bell, Shield, Smartphone, PenTool, Settings as SettingsIcon, Globe, Ruler, Activity, Sparkles, Check, ChevronRight, MapPin, ShieldAlert, Lock, Ghost, PlayCircle, Clock, CheckCircle2 } from 'lucide-react';
        ...
        <div className="bg-white/5 p-5 rounded-[2rem] border border-white/10 flex items-center gap-5">
           ...
           <div className="flex-1">
              <div className="flex justify-between items-center">
                <div>
                  <h2 className="text-lg font-black tracking-tight uppercase italic">{user.avatar.name}</h2>
                ...
                <button onClick={() => setIsChangingName(!isChangingName)} className="p-2 bg-white/5 rounded-lg text-oasis-cyan hover:bg-oasis-cyan hover:text-black transition-all">
                  <PenTool size={14}/>
                </button>
              </div>
           </div>
